...
Usage as a script:
    python3 scripts/recommender.py Moderate
...
def load_fund_performance():
    """Joins fund master with the Sharpe ratio ranking from compute_metrics.py."""
    fund_master = pd.read_csv(RAW_DIR / "01_fund_master.csv")
    sharpe_df = pd.read_csv(OUTPUT_DIR / "sharpe_values.csv")
